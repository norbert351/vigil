...
### Surfaces
- **Demo video** — 66s live take (landing → Connect onboarding → command center → night timeline → leaderboard → Qwen sleep report), servable at `/vigil-demo.mp4`; repo copy `docs/demo/vigil-demo.mp4`, re-recordable via `demo/v2/driver.cjs`
