...
| **Runnable Demo (required)** | Live: https://vigil-mg0m.onrender.com (`/`, `/app`, `/api/*`). Local: `npm start`. | ⚠️ PARTIAL — see gap (deployed DB resets on free-tier redeploy; live URL works but shows a thin ledger) |
